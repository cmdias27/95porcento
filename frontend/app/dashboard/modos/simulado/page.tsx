      ...
      <header className="w-full px-4 md:px-8 py-4 border-b-2 border-black bg-white flex items-center justify-between gap-4 shrink-0 sticky top-0 z-20">
        ...
        <div className="flex-1 text-center">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-600">
            Fase {perguntaAtual?.fase ?? 1} de {total}
          </p>
          <h1 className="text-sm md:text-base font-black text-black truncate max-w-[60vw] mx-auto">
            {perguntaAtual?.objetivo ?? ""}
          </h1>
  ...
  return (
    <header className="w-full px-4 md:px-8 py-4 border-b-2 border-black bg-white flex items-center justify-between gap-4 shrink-0 sticky top-0 z-20">
      ...
      <div className="text-center">
        <p className="text-xs font-black text-slate-800">Modo Simulado</p>
